...
After the quality control, the user can store a new FCS file containing an additional column where only the low quality events have a value higher than 10,000 only to low quality event, similarly to the flowClean flagging method.
Alternatively a new FCS containing only the high quality events can be generated. 
